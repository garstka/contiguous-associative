...
TEST_CASE("map cons move alloc pass")
{
...
#ifndef IGNORE_LIBCXX_SPECIFIC
    {
        ...
        typedef contiguous::map<const int, T, C, A> M;
        typedef V* I;
        Counter_base::gConstructed = 0;
        {
            ...
            REQUIRE(Counter_base::gConstructed == num+3);

            M m2(m1);
            REQUIRE(m2 == m1);
            REQUIRE(Counter_base::gConstructed == num+6);
